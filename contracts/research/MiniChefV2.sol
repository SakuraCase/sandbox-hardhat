...
// https://github.com/sushiswap/sushiswap/blob/710c2a739b2806ade49dd5a3b805d6cba8d92366/contracts/MiniChefV2.sol
...
contract MiniChefV2 is BoringOwnable, BoringBatchable {
    ...
    function setSushiPerSecond(uint256 _sushiPerSecond) public onlyOwner {
        console.log("---------- setSushiPerSecond ----------");
        console.log(_sushiPerSecond);
    ...
    function updatePool(uint256 pid) public returns (PoolInfo memory pool) {
        ...
        if (block.timestamp > pool.lastRewardTime) {
            ...
            if (lpSupply > 0) {
                ...
                console.log("sushiPerSecond: ", sushiPerSecond);
    ...
    function deposit(uint256 pid, uint256 amount, address to) public beforeUser(pid) afterUser(pid) {
        console.log("----- deposit -----");
        console.log(pid, amount, to);
    ...
    function withdraw(uint256 pid, uint256 amount, address to) public beforeUser(pid) afterUser(pid) {
    ...
    function harvest(uint256 pid, address to) public beforeUser(pid) afterUser(pid) {
        console.log("----- harvest -----");
        console.log(pid, to);
        PoolInfo memory pool = updatePool(pid);
        UserInfo storage user = userInfo[pid][msg.sender];
        ...
        console.log("accumulatedSushi:");
        console.logInt(accumulatedSushi);
        console.log("_pendingSushi: ", _pendingSushi);
    ...
    function withdrawAndHarvest(uint256 pid, uint256 amount, address to) public beforeUser(pid) afterUser(pid) {
        console.log("----- withdrawAndHarvest -----");
        console.log(pid, amount, to);
    ...
    /// @param pid The index of the pool. See `poolInfo`.
    /// @param to Receiver of the LP tokens.
    function emergencyWithdraw(uint256 pid, address to) public beforeUser(pid) afterUser(pid) {
